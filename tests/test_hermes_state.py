...
class TestFTS5Search:
    ...
    def test_search_projection_skips_context_enrichment_queries(
        ...
        # Query-count instrumentation must observe one stable connection.
        # Otherwise the bounded read pool may execute context enrichment on a
        # different pooled connection than the one traced below.
