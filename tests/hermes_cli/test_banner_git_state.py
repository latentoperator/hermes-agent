...
def test_get_git_banner_state_prefers_upstream_remote_and_head(tmp_path):
    from hermes_cli import banner
...
def test_get_git_banner_state_falls_back_to_origin_main(tmp_path):
    from hermes_cli import banner
    ...
    results = {
        ("git", "rev-parse", "--short=8", "upstream/main"): failed,
        ("git", "rev-parse", "--short=8", "origin/main"): MagicMock(returncode=0, stdout="b2f477a3\n"),
        ("git", "rev-parse", "--short=8", "HEAD"): MagicMock(returncode=0, stdout="af8aad31\n"),
