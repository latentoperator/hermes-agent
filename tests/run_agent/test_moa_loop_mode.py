...
def test_references_run_in_parallel(monkeypatch):
    ...
    All dispatched references must rendezvous before any can finish. Order is
    preserved and a failing reference is isolated.
    """
    import threading
    ...
    def slow_call_llm(**kwargs):
        # A serial implementation cannot pass this barrier. This verifies
        # concurrency directly without relying on sub-second wall-clock bounds.
