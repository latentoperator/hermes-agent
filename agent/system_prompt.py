...
def build_system_prompt_parts(agent: Any, system_message: Optional[str] = None) -> Dict[str, str]:
    ...
    # Kanban worker lifecycle guidance is activated only by positive dispatcher
    # task scope. Taskless orchestrator profiles may still expose board-routing
    # tools, so tool presence must never imply worker identity.
