...
def _run_bws_list(
    ...
    for attempt in range(1, _BWS_RATE_LIMIT_MAX_ATTEMPTS + 1):
        ...
        # Parallel profile starts can briefly exhaust the BSM API limit. Only
        # retry explicit throttling; auth and configuration failures still
        # return immediately through the shared error classifier.
