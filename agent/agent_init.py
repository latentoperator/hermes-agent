...
def init_agent(
    ...
    # Kanban worker lifecycle guidance is session-static. Tool presence is
    # insufficient proof of worker scope because taskless orchestrator profiles
    # intentionally retain shared board-routing tools such as kanban_show.
    # Only the dispatcher-provided task id may activate the worker protocol.
