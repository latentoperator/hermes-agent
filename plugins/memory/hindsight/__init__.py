...
class HindsightMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._turn_index = 0
        self._client = None
        # Prefetch, retain, and explicit memory-tool calls can all reach
        # _get_client() from different threads. Serialize first use so two
        # callers cannot construct separate aiohttp-backed clients and orphan
        # the losing instance.
